...
modules/videostab/precomp.hpp.gch/opencv_videostab_RELEASE.gch: lib/libopencv_videostab_pch_dephelp.a
	...
	cd /app/tmp/opencv/release/modules/videostab && /usr/bin/cmake -E make_directory /app/tmp/opencv/release/modules/videostab/precomp.hpp.gch
	cd /app/tmp/opencv/release/modules/videostab && /usr/bin/c++ -O3 -DNDEBUG -DNDEBUG -fPIC "-D__OPENCV_BUILD=1" "-DCVAPI_EXPORTS" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -I"/app/tmp/opencv/modules/videostab/include" -I"/app/tmp/opencv/modules/videostab/src" -isystem"/app/tmp/opencv/release/modules/videostab" -I"/app/tmp/opencv/modules/core/include" -I"/app/tmp/opencv/modules/flann/include" -I"/app/tmp/opencv/modules/imgproc/include" -I"/app/tmp/opencv/modules/ml/include" -I"/app/tmp/opencv/modules/photo/include" -I"/app/tmp/opencv/modules/video/include" -I"/app/tmp/opencv/modules/imgcodecs/include" -I"/app/tmp/opencv/modules/videoio/include" -I"/app/tmp/opencv/modules/highgui/include" -I"/app/tmp/opencv/modules/features2d/include" -I"/app/tmp/opencv/modules/calib3d/include" -fsigned-char -W -Wall -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Wundef -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wno-narrowing -Wno-delete-non-virtual-dtor -fdiagnostics-show-option -Wno-long-long -pthread -fomit-frame-pointer -msse -msse2 -mno-avx -msse3 -mno-ssse3 -mno-sse4.1 -mno-sse4.2 -ffunction-sections -fvisibility=hidden -fvisibility-inlines-hidden -DCVAPI_EXPORTS -x c++-header -o /app/tmp/opencv/release/modules/videostab/precomp.hpp.gch/opencv_videostab_RELEASE.gch /app/tmp/opencv/release/modules/videostab/precomp.hpp
...
modules/videostab/precomp.hpp: ../modules/videostab/src/precomp.hpp
	...
	cd /app/tmp/opencv/release/modules/videostab && /usr/bin/cmake -E copy_if_different /app/tmp/opencv/modules/videostab/src/precomp.hpp /app/tmp/opencv/release/modules/videostab/precomp.hpp
...
modules/videostab/CMakeFiles/pch_Generate_opencv_videostab.dir/clean:
	cd /app/tmp/opencv/release/modules/videostab && $(CMAKE_COMMAND) -P CMakeFiles/pch_Generate_opencv_videostab.dir/cmake_clean.cmake
...
modules/videostab/CMakeFiles/pch_Generate_opencv_videostab.dir/depend:
	cd /app/tmp/opencv/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/tmp/opencv /app/tmp/opencv/modules/videostab /app/tmp/opencv/release /app/tmp/opencv/release/modules/videostab /app/tmp/opencv/release/modules/videostab/CMakeFiles/pch_Generate_opencv_videostab.dir/DependInfo.cmake --color=$(COLOR)

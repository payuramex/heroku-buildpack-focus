...
modules/videoio/precomp.hpp.gch/opencv_videoio_RELEASE.gch: lib/libopencv_videoio_pch_dephelp.a
	...
	cd /app/tmp/opencv/release/modules/videoio && /usr/bin/cmake -E make_directory /app/tmp/opencv/release/modules/videoio/precomp.hpp.gch
	cd /app/tmp/opencv/release/modules/videoio && /usr/bin/c++ -O3 -DNDEBUG -DNDEBUG -fPIC "-D__OPENCV_BUILD=1" "-DCVAPI_EXPORTS" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -I"/app/tmp/opencv/modules/videoio/include" -I"/app/tmp/opencv/modules/videoio/src" -isystem"/app/tmp/opencv/release/modules/videoio" -I"/app/tmp/opencv/modules/core/include" -I"/app/tmp/opencv/modules/imgproc/include" -I"/app/tmp/opencv/modules/imgcodecs/include" -fsigned-char -W -Wall -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Wundef -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wno-narrowing -Wno-delete-non-virtual-dtor -fdiagnostics-show-option -Wno-long-long -pthread -fomit-frame-pointer -msse -msse2 -mno-avx -msse3 -mno-ssse3 -mno-sse4.1 -mno-sse4.2 -ffunction-sections -fvisibility=hidden -fvisibility-inlines-hidden -DCVAPI_EXPORTS -x c++-header -o /app/tmp/opencv/release/modules/videoio/precomp.hpp.gch/opencv_videoio_RELEASE.gch /app/tmp/opencv/release/modules/videoio/precomp.hpp
...
modules/videoio/precomp.hpp: ../modules/videoio/src/precomp.hpp
	...
	cd /app/tmp/opencv/release/modules/videoio && /usr/bin/cmake -E copy_if_different /app/tmp/opencv/modules/videoio/src/precomp.hpp /app/tmp/opencv/release/modules/videoio/precomp.hpp
...
modules/videoio/CMakeFiles/pch_Generate_opencv_videoio.dir/clean:
	cd /app/tmp/opencv/release/modules/videoio && $(CMAKE_COMMAND) -P CMakeFiles/pch_Generate_opencv_videoio.dir/cmake_clean.cmake
...
modules/videoio/CMakeFiles/pch_Generate_opencv_videoio.dir/depend:
	cd /app/tmp/opencv/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/tmp/opencv /app/tmp/opencv/modules/videoio /app/tmp/opencv/release /app/tmp/opencv/release/modules/videoio /app/tmp/opencv/release/modules/videoio/CMakeFiles/pch_Generate_opencv_videoio.dir/DependInfo.cmake --color=$(COLOR)

...
modules/stitching/opencv_stitching_pch_dephelp.cxx: ../modules/stitching/src/precomp.hpp
	...
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/cmake -E echo \#include\ \"/app/tmp/opencv/modules/stitching/src/precomp.hpp\" > /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/cmake -E echo int\ testfunction\(\)\; >> /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/cmake -E echo int\ testfunction\(\) >> /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/cmake -E echo { >> /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/cmake -E echo \ \ \ \ \return\ 0\; >> /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/cmake -E echo } >> /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
...
modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/opencv_stitching_pch_dephelp.cxx.o: modules/stitching/opencv_stitching_pch_dephelp.cxx
	...
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/opencv_stitching_pch_dephelp.dir/opencv_stitching_pch_dephelp.cxx.o -c /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx
...
modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/opencv_stitching_pch_dephelp.cxx.i: cmake_force
	...
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx > CMakeFiles/opencv_stitching_pch_dephelp.dir/opencv_stitching_pch_dephelp.cxx.i
...
modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/opencv_stitching_pch_dephelp.cxx.s: cmake_force
	...
	cd /app/tmp/opencv/release/modules/stitching && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /app/tmp/opencv/release/modules/stitching/opencv_stitching_pch_dephelp.cxx -o CMakeFiles/opencv_stitching_pch_dephelp.dir/opencv_stitching_pch_dephelp.cxx.s
...
lib/libopencv_stitching_pch_dephelp.a: modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/link.txt
	...
	cd /app/tmp/opencv/release/modules/stitching && $(CMAKE_COMMAND) -P CMakeFiles/opencv_stitching_pch_dephelp.dir/cmake_clean_target.cmake
	cd /app/tmp/opencv/release/modules/stitching && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/opencv_stitching_pch_dephelp.dir/link.txt --verbose=$(VERBOSE)
...
modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/clean:
	cd /app/tmp/opencv/release/modules/stitching && $(CMAKE_COMMAND) -P CMakeFiles/opencv_stitching_pch_dephelp.dir/cmake_clean.cmake
...
modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/depend: modules/stitching/opencv_stitching_pch_dephelp.cxx
	cd /app/tmp/opencv/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/tmp/opencv /app/tmp/opencv/modules/stitching /app/tmp/opencv/release /app/tmp/opencv/release/modules/stitching /app/tmp/opencv/release/modules/stitching/CMakeFiles/opencv_stitching_pch_dephelp.dir/DependInfo.cmake --color=$(COLOR)

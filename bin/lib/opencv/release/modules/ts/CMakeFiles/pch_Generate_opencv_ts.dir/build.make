...
modules/ts/precomp.hpp.gch/opencv_ts_RELEASE.gch: lib/libopencv_ts_pch_dephelp.a
	...
	cd /app/tmp/opencv/release/modules/ts && /usr/bin/cmake -E make_directory /app/tmp/opencv/release/modules/ts/precomp.hpp.gch
	cd /app/tmp/opencv/release/modules/ts && /usr/bin/c++ -O3 -DNDEBUG -DNDEBUG "-D__OPENCV_BUILD=1" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -I"/app/tmp/opencv/modules/ts/include" -I"/app/tmp/opencv/modules/ts/src" -isystem"/app/tmp/opencv/release/modules/ts" -I"/app/tmp/opencv/modules/core/include" -I"/app/tmp/opencv/modules/imgproc/include" -I"/app/tmp/opencv/modules/imgcodecs/include" -I"/app/tmp/opencv/modules/videoio/include" -I"/app/tmp/opencv/modules/highgui/include" -fsigned-char -W -Wall -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wno-narrowing -Wno-delete-non-virtual-dtor -fdiagnostics-show-option -Wno-long-long -pthread -fomit-frame-pointer -msse -msse2 -mno-avx -msse3 -mno-ssse3 -mno-sse4.1 -mno-sse4.2 -ffunction-sections -fvisibility=hidden -fvisibility-inlines-hidden -Wno-undef -x c++-header -o /app/tmp/opencv/release/modules/ts/precomp.hpp.gch/opencv_ts_RELEASE.gch /app/tmp/opencv/release/modules/ts/precomp.hpp
...
modules/ts/precomp.hpp: ../modules/ts/src/precomp.hpp
	...
	cd /app/tmp/opencv/release/modules/ts && /usr/bin/cmake -E copy_if_different /app/tmp/opencv/modules/ts/src/precomp.hpp /app/tmp/opencv/release/modules/ts/precomp.hpp
...
modules/ts/CMakeFiles/pch_Generate_opencv_ts.dir/clean:
	cd /app/tmp/opencv/release/modules/ts && $(CMAKE_COMMAND) -P CMakeFiles/pch_Generate_opencv_ts.dir/cmake_clean.cmake
.PHONY : modules/ts/CMakeFiles/pch_Generate_opencv_ts.dir/clean

modules/ts/CMakeFiles/pch_Generate_opencv_ts.dir/depend:
	cd /app/tmp/opencv/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/tmp/opencv /app/tmp/opencv/modules/ts /app/tmp/opencv/release /app/tmp/opencv/release/modules/ts /app/tmp/opencv/release/modules/ts/CMakeFiles/pch_Generate_opencv_ts.dir/DependInfo.cmake --color=$(COLOR)

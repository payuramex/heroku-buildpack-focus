...
modules/imgproc/precomp.hpp.gch/opencv_imgproc_RELEASE.gch: lib/libopencv_imgproc_pch_dephelp.a
	...
	cd /app/tmp/opencv/release/modules/imgproc && /usr/bin/cmake -E make_directory /app/tmp/opencv/release/modules/imgproc/precomp.hpp.gch
	cd /app/tmp/opencv/release/modules/imgproc && /usr/bin/c++ -O3 -DNDEBUG -DNDEBUG -fPIC "-D__OPENCV_BUILD=1" "-DCVAPI_EXPORTS" -isystem"/app/tmp/opencv/3rdparty/include/opencl/1.2" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -isystem"/app/tmp/opencv/3rdparty/include/opencl/1.2" -isystem"/app/tmp/opencv/3rdparty/ippicv/unpack/ippicv_lnx/include" -isystem"/app/tmp/opencv/release" -I"/app/tmp/opencv/modules/imgproc/include" -I"/app/tmp/opencv/modules/imgproc/src" -isystem"/app/tmp/opencv/release/modules/imgproc" -I"/app/tmp/opencv/modules/core/include" -fsigned-char -W -Wall -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Wundef -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wno-narrowing -Wno-delete-non-virtual-dtor -fdiagnostics-show-option -Wno-long-long -pthread -fomit-frame-pointer -msse -msse2 -mno-avx -msse3 -mno-ssse3 -mno-sse4.1 -mno-sse4.2 -ffunction-sections -fvisibility=hidden -fvisibility-inlines-hidden -DCVAPI_EXPORTS -x c++-header -o /app/tmp/opencv/release/modules/imgproc/precomp.hpp.gch/opencv_imgproc_RELEASE.gch /app/tmp/opencv/release/modules/imgproc/precomp.hpp
...
modules/imgproc/precomp.hpp: ../modules/imgproc/src/precomp.hpp
	...
	cd /app/tmp/opencv/release/modules/imgproc && /usr/bin/cmake -E copy_if_different /app/tmp/opencv/modules/imgproc/src/precomp.hpp /app/tmp/opencv/release/modules/imgproc/precomp.hpp
...
modules/imgproc/CMakeFiles/pch_Generate_opencv_imgproc.dir/clean:
	cd /app/tmp/opencv/release/modules/imgproc && $(CMAKE_COMMAND) -P CMakeFiles/pch_Generate_opencv_imgproc.dir/cmake_clean.cmake
...
modules/imgproc/CMakeFiles/pch_Generate_opencv_imgproc.dir/depend:
	cd /app/tmp/opencv/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/tmp/opencv /app/tmp/opencv/modules/imgproc /app/tmp/opencv/release /app/tmp/opencv/release/modules/imgproc /app/tmp/opencv/release/modules/imgproc/CMakeFiles/pch_Generate_opencv_imgproc.dir/DependInfo.cmake --color=$(COLOR)
